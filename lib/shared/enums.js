 ...
 */
export const MATURITY_LEVEL_SHORT = {
    stable: '可用',
    calibrated: '已校准',
    experimental: '实验',
    disabled: '停用',
 ...
 */
export const MANUAL_CONTACT_STAGES = ['greeted', 'delivered', 'read', 'replied', 'interview_scheduled'];
 ...
 */
export const OFFER_STATES = ['pending', 'accepted', 'declined', 'expired'];
 ...
 */
export const OFFER_OPEN_STATES = ['pending'];
