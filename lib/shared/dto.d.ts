 ...
 */
import type { ApplicationChannel, ApplicationStage, AssessmentKind, AssessmentState, CampusBatch, CampusStage, ContactStage, CoreField, CoverLetterLanguage, CrawlState, HealthState, InterviewKind, InterviewState, JobFlagType, JobState, MessageDirection, StageSource, TripartiteState, VisaStance } from './enums.js';
 ...
 * 而"为什么没跑"恰恰是用户最需要知道的。
 */
export declare const SKIP_REASONS: readonly ["not_logged_in", "adapter_broken", "risk_paused", "lease_lost", "offline_gate", "outside_window", "quota_reached", "another_run_active", "backoff", "global_pause", "plan_disabled"];
