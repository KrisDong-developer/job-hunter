 ...
 */
export function cooldownUntilOf(store, platformId) {
    if (store === undefined)
        return null;
    const cooldown = store.setting.get('cooldown-until', 'platform', platformId);
 ...
 */
export function crawlQuotaOf(store, platformId, clock) {
    if (store === undefined)
 ...
 */
export function createPlatformGate(deps) {
