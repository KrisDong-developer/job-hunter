 ...
 * 而不是只能选择"全开或全关"。
 */
export declare const AI_PURPOSES: readonly ["match_score", "explain", "jd_summary", "greeting_draft", "resume_tailor", "resume_tone_check", "interview_prep", "mock_interview", "company_intel", "stage_extract", "offer_compare", "cover_letter", "message_extract"];
