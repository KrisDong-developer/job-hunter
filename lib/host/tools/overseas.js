import { COVER_LETTER_LANGUAGES, REMOTE_KINDS, REMOTE_KIND_LABEL, VISA_STANCES, VISA_STANCE_LABEL } from '../../shared/contract/enums/overseas.js';
import { DomainError } from '../util/errors.js';
import { asString, enumStr, int, positiveId, requireData, schema, str, textResult, toInt, toolDefiner, } from './kit.js';
export function overseasTools(runtime) {
