...
import { DEFAULT_ZHAOPIN_CONFIG, ZHAOPIN_BLOCK_SIGNALS, ZHAOPIN_DEFAULT_MAX_PAGES, ZHAOPIN_MAX_PAGES, ZHAOPIN_POSTED_WITHIN_OPTIONS, ZHAOPIN_SORT_OPTIONS, } from './config.js';
...
export function createZhaopinAdapter(options = {}) {
    ...
    const dimensions = [
        ...
        },
        {
            ...
            // 城市码写在**路径段**里（`/sou/jl<码>`）—— 没有 query 参数名可对账，
