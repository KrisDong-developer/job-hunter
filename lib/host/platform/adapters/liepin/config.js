 ...
 */
export const LIEPIN_BODY_FIELDS = {
...
export function mergeLiepinConfig(override) {
    ...
    const deliveryPollOf = (value, fallback) => {
        if (value === null || typeof value !== 'object')
            return fallback;
        const candidate = value;
        return {
            attempts: positive(candidate.attempts, fallback.attempts),
            intervalMs: typeof candidate.intervalMs === 'number' && Number.isFinite(candidate.intervalMs) && candidate.intervalMs >= 0
