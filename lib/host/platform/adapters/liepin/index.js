...
import { DEFAULT_LIEPIN_CONFIG, LIEPIN_BLOCK_FLAGS, LIEPIN_BLOCK_SIGNALS, LIEPIN_BODY_FIELDS, LIEPIN_DEFAULT_MAX_PAGES, LIEPIN_FILTER_OPTIONS, LIEPIN_MAX_PAGES, } from './config.js';
...
export function createLiepinAdapter(options = {}) {
    ...
    const dimensions = [
        ...
        ...[
            ...
            hint: '取值编码来自猎聘筛选字典接口 pc-search-job-cond-init（2026-09-23 实测），' +
