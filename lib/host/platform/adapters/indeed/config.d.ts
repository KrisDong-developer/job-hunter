 ...
 */
export declare const INDEED_POSTED_WITHIN_OPTIONS: Array<{
    value: string;
    label: string;
}>;
/**
 ...
 */
export declare const INDEED_JOB_TYPE_OPTIONS: Array<{
    value: string;
    label: string;
}>;
...
export declare const INDEED_PAYLOAD_PROVIDER_KEY = "mosaic-provider-jobcards";
