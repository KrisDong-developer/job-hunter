...
export const ZHIPIN_FILTER_OPTIONS = {
    /** 面板名「求职类型」。 */
    jobType: [
        { value: '1901', label: '全职' },
        { value: '1903', label: '兼职' },
...
export const DEFAULT_ZHIPIN_CONFIG = {
    ...
    chatSelectors: {
        ...
        resumeDialogItem: '.resume-choose-container .list-item, .choose-resume-dialog .list-item, ' +
...
export function mergeZhipinConfig(override) {
     ...
     */
    const watermarkTexts = (value, fallback) => {
    ...
    return {
        ...
        detailSelectors: {
            ...
            jdWatermarkTexts: watermarkTexts(patch.detailSelectors?.jdWatermarkTexts, DEFAULT_ZHIPIN_CONFIG.detailSelectors.jdWatermarkTexts),
        },
