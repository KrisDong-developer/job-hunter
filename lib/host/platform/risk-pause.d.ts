...
export declare const RISK_PAUSE_KEY = "risk-paused";
export declare const RISK_PAUSE_SCOPE: "platform";
 ...
 */
export declare function readPlatformRiskPause(store: Store, platformId: string): PlatformRiskPause;
export declare function setPlatformRiskPause(store: Store, platformId: string, reason: string, now: string): void;
export declare function clearPlatformRiskPause(store: Store, platformId: string): void;
/**
 ...
 */
export declare function allPlatformsRiskPaused(store: Store, platformIds: readonly string[]): boolean;
//# sourceMappingURL=risk-pause.d.ts.map