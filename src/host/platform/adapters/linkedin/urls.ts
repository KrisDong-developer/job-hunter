...
function commonParams(config: LinkedInConfig, criteria: SearchCriteria): URLSearchParams {
 ...
 */
export function buildLinkedInGuestApiUrl(config: LinkedInConfig, criteria: SearchCriteria): string {
 ...
 */
export function buildLinkedInSearchUrl(config: LinkedInConfig, criteria: SearchCriteria): string {
  const params = commonParams(config, criteria)
