...
import { ZHIPIN_FILTER_OPTIONS, type ZhipinFilterKey } from './config.js'
...
const ZHIPIN_FILTER_KEYS = Object.keys(ZHIPIN_FILTER_OPTIONS) as ZhipinFilterKey[]
 ...
 */
export function zhipinFiltersOf(criteria: SearchCriteria): Partial<Record<ZhipinFilterKey, string>> {
  const out: Partial<Record<ZhipinFilterKey, string>> = {}
