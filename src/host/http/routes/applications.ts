...
import type { ApplicationChannel, ApplicationStage } from '../../../shared/enums.js'
 ...
 */
export async function deliver(ctx: RouteContext): Promise<RouteResult | undefined> {
...
export async function board(ctx: RouteContext): Promise<RouteResult | undefined> {
  const { runtime, segments, method } = ctx
...
export async function jobHistory(ctx: RouteContext): Promise<RouteResult | undefined> {
  const { runtime, segments, method } = ctx
...
export async function followups(ctx: RouteContext): Promise<RouteResult | undefined> {
  const { runtime, segments, method } = ctx
...
export async function followupsResolve(ctx: RouteContext): Promise<RouteResult | undefined> {
  const { runtime, req, segments, method } = ctx
