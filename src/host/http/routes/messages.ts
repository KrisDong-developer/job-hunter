...
export async function inbox(ctx: RouteContext): Promise<RouteResult | undefined> {
...
export async function post(ctx: RouteContext): Promise<RouteResult | undefined> {
  const { runtime, req, segments, method } = ctx
...
export async function reply(ctx: RouteContext): Promise<RouteResult | undefined> {
  const { runtime, req, segments, method } = ctx
...
export async function extractInterview(ctx: RouteContext): Promise<RouteResult | undefined> {
  const { runtime, segments, method } = ctx
...
export async function draftReply(ctx: RouteContext): Promise<RouteResult | undefined> {
  const { runtime, req, segments, method } = ctx
