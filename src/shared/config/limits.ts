 ...
 */
export const MAX_SAVED_JOB_VIEWS = 20

export const MAX_SAVED_JOB_VIEW_NAME = 40

/** 视图里每个多选项（城市 / 经验 / 学历 / 屏蔽标注）最多几项。 */
export const MAX_SAVED_JOB_VIEW_ITEMS = 20
 ...
 */
export const MAX_RESUME_GREETING_TEMPLATES = 6

/** 话术模板名字的长度上限（与保存视图的名字同一档）。 */
export const MAX_GREETING_TEMPLATE_NAME = 40
 ...
 */
export const MAX_JOB_EXPORT_IDS = 500
